export const PROFILE_COLUMNS =
  'user_id, role, display_name, is_active, is_owner, deactivated_at, created_at, updated_at, avatar_url';
...
export const CONVERSATION_COLUMNS =
  'conversation_id, type, created_by, hidden, created_at, updated_at';

export const CONVERSATION_MEMBER_COLUMNS =
  'conversation_id, user_id, last_read_at, created_at';

export const MESSAGE_COLUMNS =
  'message_id, conversation_id, author_user_id, body, created_at, updated_at';
...
export const BLOG_POST_COLUMNS =
  'post_id, author_user_id, title, body, created_at, updated_at';

export const BLOG_COMMENT_COLUMNS =
  'comment_id, post_id, author_user_id, body, created_at, updated_at';

export const ENROLLMENT_LEAD_COLUMNS =
  'lead_id, parent_name, parent_email, phone, student_name, student_age, message, source_page, notification_status, notified_at, status, approved_at, approval_email_sent_at, booking_token, appointment_date, appointment_time, denied_at, denial_message, admin_notes, created_at, deleted_at, attendance_recorded_at, attendance_recorded_by, preferred_language';
