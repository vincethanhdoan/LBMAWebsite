        ...
        <div className="space-y-10 text-sm leading-relaxed">
          ...
          <section>
            <p className="text-muted-foreground mb-4">
              ...
              <strong>Los Banos Martial Arts Academy</strong> ("we," "us," or
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
              <li>
                ...
                <a
                  href="https://www.lbmartialarts.com/"
              ...
              <li>
                Use <strong>Los Banos Martial Arts Academy Website</strong> — a
                martial arts academy website and family communication platform
                that allows prospective families to request trial appointments,
                enrolled families to access academy information, and staff to
                manage announcements, messages, student/family records, and
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4 italic">
              ...
              can find out more details about any of these topics by using the
            ...
            <div className="space-y-3 text-muted-foreground">
              ...
              <p>
                ...
                Some information may be considered "special" or "sensitive" in
                certain jurisdictions. We may process sensitive personal
              ...
              <p>
                ...
                However, no electronic transmission or information storage
              ...
              <p>
                ...
                Depending on where you are located, the applicable privacy law
              ...
              <p>
                ...
                <a
                  href="https://lbmartialarts.com/contact"
                  className="text-foreground underline underline-offset-2 hover:text-primary transition-colors"
                >
          ...
          <section id="infocollect">
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-1 mb-4">
              {[
                ...
                'admin notes and instructor feedback',
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-3">
              ...
              <li>
                ...
                numbers, browser type, hardware model, Internet service provider
          ...
          <section id="cookies">
            ...
            <p className="text-muted-foreground mb-3">
              <em>
                In Short: We use only the cookies and similar technologies
                necessary for our Services to function.
              </em>
            </p>
            <p className="text-muted-foreground mb-3">
              We use cookies and similar technologies (such as browser local
              storage) only for essential site functions — for example, keeping
              you signed in to the family portal, maintaining the security of
          ...
          <section id="infominors">
            ...
            <p className="text-muted-foreground">
              Our website and family portal are intended for use by parents,
              legal guardians, prospective families, and academy staff. We do
              not knowingly allow children under 13 to create accounts,
              register, submit information, or directly use the portal. Parents
              or legal guardians may provide information about their child or
              student for enrollment, scheduling, communication, class
              participation, and academy administration purposes. If we learn
              that a child has provided personal information directly without
              parent or guardian involvement, we will take appropriate steps to
          ...
          <section id="privacyrights">
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
              ...
              <li>
                Users may request account deletion by contacting Los Banos
                Martial Arts Academy through the contact information listed in
                this Privacy Policy. Account deletion requests may be subject to
                verification and may not include records we are required or
                permitted to retain for legal, security, administrative, or
                academy operation purposes.
              </li>
            </ul>
            <p className="text-muted-foreground mb-4">
              ...
              <table className="w-full text-sm border-collapse border border-border">
                <thead>
                  <tr className="bg-muted/50">
                    <th className="border border-border px-3 py-2 text-left font-semibold text-foreground w-2/5">
                      Category
                    </th>
                    <th className="border border-border px-3 py-2 text-left font-semibold text-foreground w-2/5">
                      Examples
                    </th>
                    <th className="border border-border px-3 py-2 text-left font-semibold text-foreground w-1/5">
                      Collected
                    </th>
                  </tr>
                </thead>
