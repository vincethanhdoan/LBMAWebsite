      ...
      >
        <DialogContent className="max-w-md">
          ...
          <p className="text-sm text-muted-foreground">
            This lead was created before program bookings existed, so dates
            can't be booked here. Create a new lead for this family to book an
            appointment.
          </p>
          <DialogFooter>
            ...
            programBookings.map((booking) => (
              ...
              >
                <div className="flex items-center gap-2 mb-3">
                  <span
                    className={`text-xs font-semibold px-2 py-0.5 rounded-full ${PROGRAM_BADGE_STYLES[booking.program_type]}`}
                  >
                  ...
                  <>
                    <BookingCalendar
                      ...
                      onConfirm={async (slotId, date) => {
                        setSelection((prev) => ({
                          ...prev,
                          [booking.booking_id]: { slotId, date },
                        }));
                      }}
                      submitting={false}
