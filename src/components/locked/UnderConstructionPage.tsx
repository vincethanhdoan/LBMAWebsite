...
const COPY = {
  en: {
    ...
    thanks:
      "Thank you for your patience. We can't wait to share what's coming.",
  },
  es: {
    ...
    thanks:
      'Gracias por tu paciencia. Estamos ansiosos por compartir lo que viene.',
  },
} as const;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="w-full"
          style={{ borderTop: `1px solid ${V3.border}`, paddingTop: '28px' }}
        >
          <h2
            style={{
              fontSize: '1.35rem',
          ...
          <div
            ...
            style={{ fontSize: '0.95rem', marginBottom: '28px' }}
          >
            <a
              href="tel:+14086200252"
              style={{ color: V3.text, fontWeight: 600 }}
            >
              (408) 620-0252
            </a>
            <a
